...
function renderItems(items) {
  ...
  chartContainer.innerHTML = items.map((item) => {
    ...
    const refreshLabel = escapeHtml(t('Refresh player') || 'Refresh player');
    ...
    return `
      <div class="plm-card ${dirClass} ${extraCardClass}" data-plm-index="${this.currentIndex}" style="--brand: ${brandColor1}; --brand-2: ${brandColor2};">
        ...
        <div class="plm-actions">
          ...
          <button class="plm-action-btn plm-refresh-btn" type="button" aria-label="Refresh player" title="Refresh player">
