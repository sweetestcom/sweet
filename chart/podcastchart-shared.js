...
function buildCastboxEpisodeRowMarkup(ep, index, activeSrc = '') {
  ...
  return `<li><button class="${cls}" type="button" data-castbox-ep-index="${index}" data-castbox-ep-src="${audioUrl}" data-castbox-ep-guid="${guid}" data-castbox-ep-title="${title}" data-castbox-ep-meta="${meta}" ${itemLink ? `data-castbox-ep-link="${itemLink}"` : ''}><span class="castbox-rss-item-index">#${index + 1}</span><span class="castbox-rss-item-body"><span class="castbox-rss-item-title">${title}</span>${meta ? `<span class="castbox-rss-item-meta">${meta}</span>` : ''}</span></button></li>`;
}
