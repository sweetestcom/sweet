...
const MY_PODCASTS_IMPORT_MODE_VALUES = ['rss', 'youtube', 'opml'];
...
function updateMyPodcastsImportUi() {
  ...
  if (myPodcastsAddBtnEl) {
    ...
    myPodcastsAddBtnEl.setAttribute('title', myPodcastsImportMode === 'youtube' ? 'Add YouTube' : 'Add RSS');
    myPodcastsAddBtnEl.setAttribute('aria-label', myPodcastsImportMode === 'youtube' ? 'Add YouTube' : 'Add RSS');
  }
...
async function resolveYouTubeImportMeta(candidate) {
  ...
  let image = String((oembedMeta && oembedMeta.image) || (runtimeMeta && runtimeMeta.image) || '').trim();
...
function ensureMyPodcastsControls() {
      ...
      <div class="my-podcasts-library-head">
        <div class="my-podcasts-toolbar">
          ...
          <div class="my-podcasts-import-modes" id="my-podcasts-import-modes" role="group" aria-label="Import type">
            <button class="my-podcasts-mode is-active" type="button" data-my-podcasts-import-mode="rss" aria-pressed="true">RSS</button>
            <button class="my-podcasts-mode" type="button" data-my-podcasts-import-mode="youtube" aria-pressed="false">YouTube</button>
            <button class="my-podcasts-mode" type="button" data-my-podcasts-import-mode="opml" aria-pressed="false">OPML</button>
          </div>
        </div>
  ...
  if (myPodcastsAddBtnEl && !myPodcastsAddBtnEl.dataset.boundClick) {
    myPodcastsAddBtnEl.addEventListener('click', () => {
      const runner = myPodcastsImportMode === 'youtube' ? handleMyPodcastsAddYouTube : handleMyPodcastsAddRss;
      runner().catch((error) => {
