...
function shouldApplyDataBackfill(platform, type) {
  ...
  const backfillPlatforms = [
    ...
    'sverigesradio', 'podplay', 'radionet', 'podcastaddict', 'radiko', 'orfsound', 'raiplaysound', 'srfaudio', 'drlyd', 'rtbfauvio', 'rneaudio', 'npoluister', 'snipd', 'soundon', 'kkbox',
...
function getEligiblePlatformsForAll(type = (typeSelect ? typeSelect.value : 'top-podcasts'), country = (countrySelect ? countrySelect.value : 'us')) {
  ...
  return options
    ...
    .filter((value) => value !== 'ximalaya' && value !== 'bilibili' && value !== 'ardsounds' && value !== 'radiofrance' && value !== 'podimo' && value !== 'podcastaddict' && value !== 'abclisten' && value !== 'nrk' && value !== 'yleareena' && value !== 'sverigesradio' && value !== 'podplay' && value !== 'siriusxm' && value !== 'podcastapp' && value !== 'rtlplus' && value !== 'orfsound' && value !== 'raiplaysound' && value !== 'srfaudio' && value !== 'drlyd' && value !== 'rtbfauvio' && value !== 'rneaudio' && value !== 'npoluister' && value !== 'snipd' && value !== 'soundon' && value !== 'kkbox')
...
function normalizeItems(data, platform, type) {
  ...
  if (platform === 'ardsounds' || platform === 'radiofrance' || platform === 'bbcsounds' || platform === 'siriusxm' || platform === 'pandora' || platform === 'podcastapp' || platform === 'rtlplus' || platform === 'tunein' || platform === 'abclisten' || platform === 'nrk' || platform === 'yleareena' || platform === 'sverigesradio' || platform === 'podplay' || platform === 'podimo' || platform === 'podcastaddict' || platform === 'radionet' || platform === 'ivoox' || platform === 'orfsound' || platform === 'raiplaysound' || platform === 'srfaudio' || platform === 'drlyd' || platform === 'rtbfauvio' || platform === 'rneaudio' || platform === 'npoluister' || platform === 'snipd' || platform === 'soundon' || platform === 'kkbox') {
    arr = Array.isArray(data && data.podcasts) ? data.podcasts : [];
