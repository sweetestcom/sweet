...
function getSurpriseSparkSvg() {
  return '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="M11.99 2.6c.28 0 .5.18.58.52l.55 2.44c.18.8.8 1.42 1.6 1.6l2.44.55c.34.08.52.3.52.58s-.18.5-.52.58l-2.44.55c-.8.18-1.42.8-1.6 1.6l-.55 2.44c-.08.34-.3.52-.58.52s-.5-.18-.58-.52l-.55-2.44c-.18-.8-.8-1.42-1.6-1.6l-2.44-.55c-.34-.08-.52-.3-.52-.58s.18-.5.52-.58l2.44-.55c.8-.18 1.42-.8 1.6-1.6l.55-2.44c.08-.34.3-.52.58-.52Zm6.48 11.46c.22 0 .39.14.45.39l.31 1.38c.1.46.46.82.92.92l1.38.31c.25.06.39.23.39.45s-.14.39-.39.45l-1.38.31a1.31 1.31 0 0 0-.92.92l-.31 1.38c-.06.25-.23.39-.45.39s-.39-.14-.45-.39l-.31-1.38a1.31 1.31 0 0 0-.92-.92l-1.38-.31c-.25-.06-.39-.23-.39-.45s.14-.39.39-.45l1.38-.31c.46-.1.82-.46.92-.92l.31-1.38c.06-.25.23-.39.45-.39Z"/></svg>';
}
...
const globalRssPlayerController = {
  ...
  getMediaCurrentTime() {
    if (this.isBilibiliItem()) return 0;
  ...
  playCurrent() {
    ...
    if (this.isBilibiliItem(currentItem)) {
      if (this.currentIndex >= 0) return this.ensureBilibiliPlayerForItem(currentItem, { autoplay: true });
