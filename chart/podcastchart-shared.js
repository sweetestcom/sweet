...
function getEligiblePlatformsForAll(type = (typeSelect ? typeSelect.value : 'top-podcasts'), country = (countrySelect ? countrySelect.value : 'us')) {
  ...
  return options
    ...
    .filter((value) => value !== 'ximalaya' && value !== 'bilibili' && value !== 'ardsounds' && value !== 'radiofrance' && value !== 'podimo' && value !== 'podcastaddict' && value !== 'abclisten' && value !== 'nrk' && value !== 'yleareena' && value !== 'sverigesradio' && value !== 'podplay' && value !== 'siriusxm' && value !== 'podcastapp' && value !== 'rtlplus' && value !== 'orfsound' && value !== 'raiplaysound' && value !== 'srfaudio' && value !== 'drlyd' && value !== 'rtbfauvio' && value !== 'rneaudio' && value !== 'npoluister' && value !== 'snipd' && value !== 'netflix' && value !== 'disneyplus' && value !== 'soundon' && value !== 'kkbox')
